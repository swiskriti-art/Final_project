...
This data has binary response variable `diabetes_binary` that gives whether there is diabetes or not. Our response variable is a categorical variable so a classification task, when we have categorical variable as response like success or failure we can use logistic regression model for predictions.
